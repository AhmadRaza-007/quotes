                            ...
                            <div class="alert alert-success">
                                ...
                                @if(session('api_key'))
                                    <div class="mt-2">
                                        ...
                                        <code class="d-block mt-1 p-2 bg-light border rounded">{{ session('api_key') }}</code>
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->email }}</td>
                                            <td>
                                                <span class="badge {{ $user->api_keys_count > 0 ? 'bg-success' : 'bg-secondary' }}">
                                                    {{ $user->api_keys_count }}
                                                </span>
                                            </td>
                                            <td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            userApiKeysModal.addEventListener('show.bs.modal', function (event) {
                ...
                // Show loading state
                document.getElementById('apiKeysList').innerHTML = '<div class="text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div></div>';
                ...
                .catch(error => {
                    ...
                    document.getElementById('apiKeysList').innerHTML = '<div class="alert alert-danger">Error loading API keys. Please try again.</div>';
                });
            });
        });
