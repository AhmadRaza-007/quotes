<!-- resources/views/admin/api-keys/manage.blade.php -->
@extends('app')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3>All API Keys</h3>
                        <div>
                            <a href="{{ route('admin.api-keys.apps') }}" class="btn btn-secondary me-2">
                    ...
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($apiKeys as $apiKey)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($apiKey->category)
                                                        <span class="badge bg-primary">{{ $apiKey->category->name }}</span>
                                                    @else
                                                        <span class="text-muted">No App</span>
                                                    @endif
                                                </td>
                                                <td>
                        ...
                        @else
                            <div class="alert alert-info text-center">
                                ...
                                No API keys found.
                                <a href="{{ route('admin.api-keys.apps') }}" class="alert-link">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.api-keys.generate') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="category_id" class="form-label">App</label>
                            ...
                            <div class="form-text">
                                <a href="{{ route('admin.api-keys.apps.create') }}">Create new App</a>
                            </div>
                        </div>
                        <div class="mb-3">
